...
demo-claude-code-multiplex_cmdline() {
  case "${1}" in
    --deploy-demo-claude-code-multiplex) DEMO_ACTION=(demo-claude-code-multiplex_deploy) ;;
    --delete-demo-claude-code-multiplex) DEMO_ACTION=(demo-claude-code-multiplex_delete) ;;
    *)
      return 1
      ;;
  esac
